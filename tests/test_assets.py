...
adc_sampling_times_8_samples = arange(0, 8/adc_sampling_frequency_0,
                                      1/adc_sampling_frequency_0)
adc_sampling_times_64_samples = arange(0, 64/adc_sampling_frequency_0,
                                       1/adc_sampling_frequency_0)
adc_sampling_times_1024_samples = arange(0, 1024/adc_sampling_frequency_0,
                                         1/adc_sampling_frequency_0)

adc_8_values_complex_fif00 = array([0. + 0.j, 0.52230123+0.85276106j,
                                    -0.48644699 + 0.87371009j,
                                    -0.99998642 + 0.00521191j,
                                    -0.49552783 - 0.86859206j,
                                    0.51338395 - 0.85815903j,
                                    0.9996648 + 0.02589005j,
                                    0.46827505 + 0.88358275j])
adc_8_values_complex_fif00 = array([0. + 0.j,
                                    0.5067312 + 0.86210411j,
                                    -0.5022311 + 0.86473344j,
                                    -0.9999162 - 0.01294611j,
                                    -0.47967476 - 0.87744636j,
                                    0.52888126 - 0.84869583j,
                                    0.9990299 + 0.0440371j,
                                    0.45215427+0.89193975j])
