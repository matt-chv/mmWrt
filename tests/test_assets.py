...
radar00 = Radar(transmitter=tdm_1chirp_8adc, receiver=receiver0)
radar11 = Radar(transmitter=tdm_1chirp_1024adc, receiver=receiver1)

radar_tdm_2_chirp_8adc = Radar(transmitter=tdm_2chirp_8adc,
                               receiver=receiver0)

target_static_5p1m = Target(xt=lambda t: d0+0*t)
target_static_10p1m = Target(xt=lambda t: d1+0*t)
target_linear_speed_1mps = Target(xt=lambda t: d0+v_1mps*t)
