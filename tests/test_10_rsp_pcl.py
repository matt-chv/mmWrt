...
from test_assets import radar_tdm_32loop_16T16R_64adc, scatterer_static_5p1m, \
...
from mmWrt.RadarSignalProcessing import ranges_dft_cfar, range_doppler
...
def test_pcl_xyz():
    ...
    # adc values are
    # (frame_count, tx_count * chirp_per_tx, rx_count, adc_count)
    # reshape to
    # (frame_count, chirp_per_tx, virtual_antennas_z,
    #  virtual_antennas_x, adc_count)
