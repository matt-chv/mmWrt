...
def TX_Freq(timestamps: NDArray, multiplexing: Literal["TDM", "DDM"] = "TDM") -> NDArray:
    ...
    times = times[...,None]  #[:, None, None, None]  # [timestamp_count, 1, 1] T/TX/S/RX
    ...
    #
    # Each timestamp is compared against every (antenna, chirp) pair —
    # no loops needed.
    # [timestamp_count, antenna_count, chirp_count]
    print(69, times.shape, chirp_start.shape)
